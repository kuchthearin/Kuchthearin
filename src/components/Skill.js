...
const Skill = () => {
  return (
    <>
     <h2 className='font-bold text-8xl mt-64 w-full text-center text-primary dark:text-primaryDark md:text-6xl md:mt-32'>Skills</h2>
     ...
     sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
          ...
          <Skills name="BootStrap" x="0vw" y="12vw"/>
          <Skills name="ReactJS" x="-20vw" y="-15vw"/>
          <Skills name="NextJS" x="15vw" y="-12vw"/>
          <Skills name="Web Design" x="32vw" y="-5vw"/>
          <Skills name="Tailwind CSS" x="0vw" y="-20vw"/>
          <Skills name="WordPress" x="-25vw" y="18vw"/>
