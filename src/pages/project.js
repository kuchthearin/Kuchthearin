  ...
  return (
    ...
    xs:right-2 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]'/>
      ...
      <div className='w-1/2 flex flex-col items-start justify-between pl-6  lg:pl-0 lg:pt-6'>
        ...
        <Link href={link} target="_blank"
        className='ml-4 rounded-lg bg-primary text-light p-2 px-6 text-lg font-samibold dark:bg-primaryDark
        sm:px sm:text-base'
        > Visit project</Link>
        </div>
      </div>
...
const Project = ({title, type, img, link, github}) => {
  return(
    ...
    border border-solid border-primary bg-light p-6 relative dark:border-dark xs:p-4'>
      <div className='bg-primary absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem] rounded-br-3xl dark:bg-primaryDark
      ...
      <div className='w-full flex flex-col items-start justify-between mt-4 '>
        ...
        <Link href={link} target="_blank"
        className=' text-lg font-samibold underline md:text-base'
        > Visit</Link>
...
const project = () => {
  return (
    <>
    <Head>
    <title>KUCHTHEARIN | Projects Page</title>
    ...
    <main className='w-full mb-16 flex flex-col items-center justify-center '>
        <Layout className='pt-16 '>
            ...
            clasName='mb-16 text-primary dark:text-primaryDark
            lg:!text-7xl sm:mb-8 sm:!text-6xl xs:!text-4xl'
            />
            <div className='grid grid-cols-12 gap-24
            gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
